    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="批改意见" prop="pigaiyijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="批改意见"
                  v-model="ruleForm.pigaiyijian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pigaiyijian" label="批改意见" prop="pigaiyijian">
                    <span>{{ruleForm.pigaiyijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pingfen = true;
          ...
          if(o=='pigaiyijian'){
            this.ruleForm.pigaiyijian = obj[o];
	    this.ro.pigaiyijian = true;
            continue;
          }
          if(o=='dengjiriqi'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zuoyepigai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zuoyepigaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
