<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学期" prop="xueqi">
          <el-input v-model="ruleForm.xueqi" 
              placeholder="学期" clearable  :readonly="ro.xueqi"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.zuoye" label="作业" prop="zuoye">
          <file-upload
          tip="点击上传作业"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.zuoye?ruleForm.zuoye:''"
          @change="zuoyeUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.zuoye" label="作业" prop="zuoye">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zuoye)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="提交日期" prop="tijiaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.tijiaoriqi" 
                type="date"
                :readonly="ro.tijiaoriqi"
                placeholder="提交日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tijiaoriqi" label="提交日期" prop="tijiaoriqi">
              <el-input v-model="ruleForm.tijiaoriqi" 
                placeholder="提交日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.tijiaoriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueqi = true;
          ...
          if(o=='zuoye'){
            this.ruleForm.zuoye = obj[o];
	    this.ro.zuoye = true;
            continue;
          }
          if(o=='tijiaoriqi'){
            this.ruleForm.tijiaoriqi = obj[o];
	    this.ro.tijiaoriqi = true;
            continue;
          }
          if(o=='jiaoshigonghao'){
	...
	if(this.ruleForm.zuoye!=null) {
		this.ruleForm.zuoye = this.ruleForm.zuoye.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    zuoyeUploadChange(fileUrls) {
	this.ruleForm.zuoye = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
