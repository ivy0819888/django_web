  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">教师邮箱</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshiyouxiang" class="input" type="text" placeholder="教师邮箱">
			   </div>
			 </div> -->
			<el-form-item label="教师邮箱" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshiyouxiang" autocomplete="off" placeholder="教师邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`jiaoshi` == this.tableName && this.ruleForm.jiaoshiyouxiang&&(!this.$validate.isEmail(this.ruleForm.jiaoshiyouxiang))){
        this.$message.error(`教师邮箱应输入邮件格式`);
        return
      }
      this.$http({
        url: url,
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220103/2e539a9e3232421fad72da44278ef58a.png);
